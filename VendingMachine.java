...
JLabel product1price = new JLabel("Rs 20", JLabel.CENTER);
...
JLabel product2price = new JLabel("Rs 45", JLabel.CENTER);
...
JLabel product3price = new JLabel("Rs 35", JLabel.CENTER);
...
JLabel product4price = new JLabel("Rs 10", JLabel.CENTER);
...
JLabel product5price = new JLabel("Rs 20", JLabel.CENTER);
...
JLabel product6price = new JLabel("Rs 20", JLabel.CENTER);
...
JLabel product7price = new JLabel("Rs 85", JLabel.CENTER);
...
JLabel product8price = new JLabel("Rs 20", JLabel.CENTER);
...
JLabel product9price = new JLabel("Rs 30", JLabel.CENTER);
...
JLabel product10price = new JLabel("Rs 10", JLabel.CENTER);
...
JTextField selectedItemTotal = new JTextField("Rs 0.00", 30);
...
JTextField moneyInput = new JTextField("Rs 0.00", 30);
...
JButton CFtwoHundredRupeeButton = new JButton("", twoHundredRupeeImage);
...
JLabel CFchangeRemainingLabel = new JLabel("Please Collect Rs. ");
...
public void changeFrameInit()
{
    ...
    CFtwoHundredRupeeButton.setBounds(420,80,68,68);
    CFtwoHundredRupeeButton.addActionListener(this);
    changeFrame.add(CFtwoHundredRupeeButton);
...
public void actionPerformed(ActionEvent e)
{
    ...
    if (e.getSource() == product1)
    {
        ...
        writeString ="INSERT INTO VendingMachine(Products, Price) VALUES('Kurkure', 'Rs 20')";
        ...
        productTotal += 20;
        selectedItemTotal.setText(currencyFormat.format(productTotal));
    ...
    {
        //adds product to the database
        writeString = "INSERT INTO VendingMachine(Products, Price) VALUES('Protein Bar', 'Rs 45')";
        //adds the text string the the selected items text field
        addToSelection = selectedItems.getText() + "\n Protein Bar - Rs 45";
        selectedItems.setText(addToSelection);
        productTotal += 45;
    ...
    {
        //adds product to the database
        writeString = "INSERT INTO VendingMachine(Products, Price) VALUES('Coca Cola', 'Rs 35')";
        //adds the text string the the selected items text field
        addToSelection = selectedItems.getText() + "\n Coca Cola - Rs 35";
        selectedItems.setText(addToSelection);
        productTotal += 35;
    ...
    {
        //adds product to the database
        writeString = "INSERT INTO VendingMachine(Products, Price) VALUES('Oreo', 'Rs 10')";
        //adds the text string the the selected items text field
        addToSelection = selectedItems.getText() + "\n Oreo - Rs 10";
        selectedItems.setText(addToSelection);
        productTotal += 10;
    ...
    if (e.getSource() == product5)
    {
        //adds product to the database
        writeString =
        "INSERT INTO VendingMachine(Products, Price) VALUES('Bisleri', 'Rs 20')";
        //adds the text string the the selected items text field
        addToSelection = selectedItems.getText() + "\n Bisleri - Rs 20";
        selectedItems.setText(addToSelection);
        productTotal += 20;
    ...
    {
        //adds product to the database
        writeString = "INSERT INTO VendingMachine(Products, Price) VALUES('KitKat', 'Rs 20')";
        //adds the text string the the selected items text field
        addToSelection = selectedItems.getText() + "\n KitKat - Rs 20";
        selectedItems.setText(addToSelection);
        productTotal += 20;
        ...
        {
            //adds product to the database
            writeString = "INSERT INTO VendingMachine(Products, Price) VALUES('DairyMilk Silk', 'Rs 85')";
            addToSelection = selectedItems.getText() + "\n DairyMilk Silk- Rs 85";
            selectedItems.setText(addToSelection);
            productTotal += 85;
            selectedItemTotal.setText(currencyFormat.format(productTotal));
            //updates the stock count by deducting 1
        ...
        {
        //adds product to the database
        writeString = "INSERT INTO VendingMachine(Products, Price) VALUES('Amul Kool', 'Rs 20')";
        addToSelection = selectedItems.getText() + "\n Amul Kool - Rs 20";
        selectedItems.setText(addToSelection);
        productTotal += 20;
        selectedItemTotal.setText(currencyFormat.format(productTotal));
        ...
        {
            //adds product to the database
            writeString = "INSERT INTO VendingMachine(Products, Price) VALUES('Appy Fizz', 'Rs 30')";
            //adds the text string the the selected items text field
            addToSelection = selectedItems.getText() + "\n Appy Fizz - Rs 30";
            selectedItems.setText(addToSelection);
            productTotal += 30;
        ...
        {
            //adds product to the database
            writeString = "INSERT INTO VendingMachine(Products, Price) VALUES('Bhujia', 'Rs 10')";
            //adds the text string the the selected items text field
            addToSelection = selectedItems.getText() + "\n Bhujia - Rs 10";
            selectedItems.setText(addToSelection);
            productTotal += 10;
        ...
        if (e.getSource() == cancelOrder)
        {
            ...
            moneyInput.setText(currencyFormat.format(productTotal - productTotal));
            selectedItemTotal.setText("Rs 0.00");
        ...
        if (e.getSource() == enterCurrency)//if enter notes button is pressed:
        {
            ...
            {
                outputMessage.setText(currencyFormat.format(totalInserted) + " Accepted! \n\nThank you for your purchase!");
                outputMessage.setBackground(Color.green);
                //clear all other areas once accepted:
                selectedItems.setText("");
                selectedItemTotal.setText("Rs 0.00");
                moneyInput.setText("Rs 0.00");
                //reset values to 0
                totalInserted = 0;
                productTotal = 0;
            }
            else if (totalInserted < productTotal)//Not enough money is input
            {
                ...
                //this sum is then applied with currency format to the output message to tell the user:
                outputMessage.setText("Error! Please input the correct amount!\n\n You still have " + currencyFormat.format(errorInputShort) + " to pay!");
                outputMessage.setBackground(Color.red);
            }
            else if (totalInserted > productTotal)//if too much money is input
            {
                ...
                //this is then added to the output message (with currency format)
                outputMessage.setText(currencyFormat.format(totalInserted) + " Accepted! Thank you for your purchase!\nPlease take your " + currencyFormat.format(errorGiveChange) + " change.\nPress the 'Take Change' button below:");
                outputMessage.setBackground(Color.green);
                //clear textfields
                selectedItems.setText("");
                selectedItemTotal.setText("Rs 0.00");
        ...
        if (e.getSource() == CFtenRupeeButton)
        {
            ...
            if (tenRStockNum == 0)
            {
                ...
                showMessageDialog(null, "Sorry, there are no Rs 10 notes left.\n\nPlease select other notes.", "Stock Depleted!", JOptionPane.WARNING_MESSAGE);
            }
        }
        if (e.getSource() == CFtwentyRupeeButton)
        {
            ...
            if (twentyRStockNum == 0)
            {
                ...
                showMessageDialog(null, "Sorry, there are no Rs 20 notes left.\n\nPlease select other notes.", "Stock Depleted!", JOptionPane.WARNING_MESSAGE);
            }
        }
        //CF 50p
        ...
        showMessageDialog(null, "Sorry, there are no Rs 50 notes left.\n\nPlease select other notes.", "Stock Depleted!", JOptionPane.WARNING_MESSAGE);
        }
        }
        ...
        showMessageDialog(null, "Sorry, there are no Rs 100 notes left.\n\nPlease select other notes.", "Stock Depleted!", JOptionPane.WARNING_MESSAGE);
        }
        }
        if (e.getSource() == CFtwoHundredRupeeButton)
        {
        //deducts one count from the change stock
        ...
        {
            CFtwoHundredRupeeButton.setEnabled(false);
            showMessageDialog(null, "Sorry, there are no Rs 200 notes left.\n\nPlease select other notes.", "Stock Depleted!", JOptionPane.WARNING_MESSAGE);
        }
    }
        //CF finished button
    if (e.getSource() == CFfinished)
    {
        ...
        if (calcChange > 0)
        {
            CFoutputMessage.setText(" Error!\n\nYou still have Rs " + decFormat.format(calcChange) + " in change to take!");
            CFoutputMessage.setBackground(Color.red);
        }
        if (calcChange == 0)
        {
    ...
    if (e.getSource() == CFclose)
    {
        ...
        CFtwoHundredRupeeButton.setEnabled(true);
    ...
    if (e.getSource() == returnCurrency)
    {
        ...
        {
            outputMessage.setText(currencyFormat.format(totalInserted) + " Returned. \n\nPlease take your money.");
            outputMessage.setBackground(Color.red);
            //clear money input
            moneyInput.setText("Rs 0.00");
    ...
    if(e.getSource() == fiveRupeeButton)
    {
        ...
        totalInserted += 5;
        moneyInput.setText(currencyFormat.format(totalInserted));
        //updates the stock count by deducting 1
        fiveRStockNum += 1;
